...
motor_list = [
              ...
              AddMotor("Emrax 348 1:1", 210E3, 500, 4000, 41),
              AddMotor("Emrax 348 2:1", 210E3, 500*2, 4000/2, 43),
               AddMotor("Emrax 348 3:1", 210E3, 500*3, 4000/3, 43),
              ]

df = pd.DataFrame(columns=["Motor Name", "Mass", "Torque", "Continous Power", "RPM"])
df = df.append([motor for motor in motor_list])
df["Continous Power"] /= 1E3
...
for motor in motor_list:
    ...
    plothusly(cplot, prop.x, prop.c, 
            xtitle=r"Fraction of Propeller Blade $x$", 
...
print_col_ind = ["motor", "T", "TWR", "C_T", "Q", "P", "eta_P"]
